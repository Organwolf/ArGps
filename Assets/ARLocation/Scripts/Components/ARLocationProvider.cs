...
namespace ARLocation
{
    ...
    {
        [Serializable]
        public class LocationEnabledUnityEvent : UnityEvent<LocationReading> {}
        [Serializable]
        public class LocationUpdatedUnityEvent : UnityEvent<LocationReading> {}
        ...
        {
            OnRawLocationUpdated?.Invoke(currentLocation);
        }
        ...
        private void OnProviderEnabledDelegate()
        {
            ...
            OnEnabled?.Invoke(CurrentLocation);
        }
